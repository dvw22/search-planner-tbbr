function [cell_seq_waypoints, num_cells] = cell_seq_search_path(cell_seq,decomposed_map,resolution)
...
for i = 1:num_cells
    [cell_waypoints, num_waypoints] = cell_search_path(decomposed_map, cell_seq(i), resolution);
